...
def download_mermaid(mermaid_code, output_filename):
    ...
    output_path = os.path.join(r'C:\Users\hieum\AndroidStudioProjects\QoSScheduler\thesis\figures', output_filename)
        ...
        try:
            ...
            with urllib.request.urlopen(req) as response:
                ...
                with open(output_path, 'wb') as out_file:
                    out_file.write(data)
            print(f'Downloaded {output_filename} successfully! Size: {len(data)} bytes')
            return
