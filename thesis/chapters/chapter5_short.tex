...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/result1_token_bucket.png}
\caption{TCP throughput convergence to the 5 Mbps cap.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/result2_wfq.png}
\caption{WFQ proportional bandwidth allocation across three applications.}
\label{fig:wfq_chart}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/result3_latency.png}
\caption{Latency comparison: baseline Bufferbloat vs. QoS-enabled.}
